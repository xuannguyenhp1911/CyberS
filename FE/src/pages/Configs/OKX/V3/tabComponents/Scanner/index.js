...
import { deleteStrategiesMultipleScannerV3, getAllConfigScannerV3, handleBookmarkScannerV3, updateStrategiesMultipleScannerV3 } from '../../../../../../services/Configs/OKX/V3/scannerService';
import { getTotalFutureByBot } from '../../../../../../services/Configs/OKX/V3/configService';
...
function ScannerV3() {
    ...
    const handleGetAllBotByUserID = () => {
        ...
        getAllBotActiveByUserID(userData._id, "OKX_V3")
            .then(res => {
