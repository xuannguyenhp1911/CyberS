...
import { updateStrategiesMultiple, deleteStrategiesMultiple, copyMultipleStrategiesToSymbol, copyMultipleStrategiesToBot, getAllSymbol } from '../../../../../../../../services/Configs/OKX/V3/configService';
...
function EditMulTreeItem({
    ...
    const handleGetAllBot = async () => {
        try {
            const res = await getAllBotActive("OKX_V3")
