...
import { createStrategies } from "../../../../../../../../services/Configs/OKX/V3/configService";
...
function CreateStrategy({
    ...
    const DEFAULT_REMEMBER_VALUE = JSON.parse(localStorage.getItem("OKX_V3_Config"))
    ...
    const handleSubmitCreate = async data => {
        ...
        if (symbolGroupData.length > 0 && botList.length > 0) {
            try {
                ...
                if (data.Remember) {
                    localStorage.setItem("OKX_V3_Config", JSON.stringify(data))
                }
            }
            catch (err) {
                dispatch(addMessageToast({
                    ...
                    <div className={clsx(styles.formControl, styles.formMainDataItem, styles.formMainDataSmall)} >
                        ...
                        <FormControl className={clsx(styles.formMainDataSmallItem)}>
                            <TextField
                                ...
                                label="Max OC (%)"
                                variant="outlined"
                                defaultValue={DEFAULT_REMEMBER_VALUE?.StopLose || 400}
                                size="medium"
