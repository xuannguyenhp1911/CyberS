...
import { MenuItem, Select, TextField, Avatar, FormLabel, FormControl, Tooltip, Table, TableBody, TableCell, TableHead, TableRow, Switch } from '@mui/material';
...
import { getTotalFutureByBot, getAllStrategies } from '../../../../../../services/Configs/OKX/V3/configService';
import { addMessageToast } from '../../../../../../store/slices/Toast';
import { setTotalFuture } from '../../../../../../store/slices/TotalFuture';

function ConfigOKXV3() {
                                    ...
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>
                                            <RemoveRedEyeIcon
                                                ...
                                                onClick={() => {
                                                    navigate("/Configs/OKX/V3/ConfigHistory", {
                                                        state: {
                                                            data: data.data,
