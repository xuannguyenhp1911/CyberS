...
import { createStrategiesSpot } from "../../../../../../../../services/Configs/OKX/V1/futuresService";
...
function CreateStrategy({
    ...
    const DEFAULT_REMEMBER_VALUE = JSON.parse(localStorage.getItem("OKX_V1_Futures"))
    ...
    const handleSubmitCreate = async data => {
        ...
        if (symbolGroupData.length > 0 && botList.length > 0) {
            try {
                ...
                if (data.Remember) {
                    localStorage.setItem("OKX_V1_Futures", JSON.stringify(newData))
                }
            }
            catch (err) {
                dispatch(addMessageToast({
