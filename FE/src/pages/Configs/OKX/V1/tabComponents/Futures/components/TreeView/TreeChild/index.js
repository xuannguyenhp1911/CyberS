...
import { updateStrategiesSpotByID, deleteStrategiesItemSpot } from '../../../../../../../../../services/Configs/OKX/V1/futuresService';
    ...
    const handleSetLeverSymbolBot = async (leverDataNew) => {
        try {
            ...
            if (status === 200) {
                ...
                const newLever = (treeNode?.Mode || PositionSide == "Long" ? "cross" : "isolated") == "cross" ? {
                    cross: {
                        long: lever,
                        short: lever,
                    },
            ...
            <TableRow className={styles.treeChild} key={treeNode.value} style={{
                ...
                <TableCell className={styles.tableBodyCell} style={{ minWidth: "100px" }}>
                    ...
                    >
                        ...
                        {
                            (treeNode.Mode || treeNode.PositionSide === "Long" ? "cross" : "isolated") == "cross" ? (
