...
import { createConfigByBitV3VIP, getAllConfigByBitV3VIP, clearVConfigByBitV3VIP } from "../../../../services/Configs/OKX/V3/configVIPService";
import { addMessageToast } from "../../../../store/slices/Toast";

function ConfigOKXV3TabV() {
    ...
    const tabList = [
        {
            label: "Config",
            value: "Configs/OKX/V3V/Config",
        },
        {
            label: "BigBabol",
            value: "Configs/OKX/V3V/BigBabol",
        }
    ]
...
export default ConfigOKXV3TabV;