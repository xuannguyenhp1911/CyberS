...
import { deleteStrategiesMultipleScannerV3, getAllConfigScannerV3, handleBookmarkScannerV3, updateStrategiesMultipleScannerV3 } from '../../../../../../services/Configs/Binance/V3/scannerService';


function ScannerBinanceV3() {
    ...
    const tableColumns = [
        ...
        },
        {
            field: 'TP',
            headerName: 'TP',
            minWidth: window.innerWidth <= 740 ? 110 : 100,
            flex: window.innerWidth <= 740 ? undefined : 1,
        },
        {
            field: 'ReTP',
        ...
        },
        {
            ...
            minWidth: window.innerWidth <= 740 ? 150 : 160,
            flex: window.innerWidth <= 740 ? undefined : 1,
        },
        {
            field: 'Turnover',
            headerName: 'Vol24h ($)',
            minWidth: window.innerWidth <= 740 ? 150 : 150,
            flex: window.innerWidth <= 740 ? undefined : 1,
            renderCell: params => {
                return <p >{formatNumberString(params.row['Turnover'] * 10 ** 6 || 0)}</p>
            }
        },

        {
            field: 'Expire',
            headerName: 'Exp (h)',
            minWidth: window.innerWidth <= 740 ? 130 : 120,
            flex: window.innerWidth <= 740 ? undefined : 1,
        },
        {
            field: 'OnlyPairs',
    ...
    const handleGetAllBotByUserID = () => {
        ...
        getAllBotActiveByUserID(userData._id, "Binance_V3")
            .then(res => {
...
export default ScannerBinanceV3;