...
import { updateConfigByIDV3 } from '../../../../../../../../services/Configs/Binance/V3/scannerService';
    ...
    >
                    ...
                    <div className={clsx(styles.formControl, styles.formMainDataItem, styles.formMainDataSmall)} >
                        ...
                        <FormControl className={clsx(styles.formMainDataSmallItem)}>
                            <TextField
                                ...
                                label="Entry"
                                variant="outlined"
                                defaultValue={dataInput.Entry || dataInput.TP}
                                size="medium"
                                InputProps={{
                                    endAdornment: <InputAdornment position="end">
                                        %
                    ...
                    <div style={{
                        ...
                        <FormControl className={clsx(styles.formControl, )}>
                            ...
                            <Switch
                                color="success"
                                defaultChecked={dataInput.IsOCWait}
                                {...register("IsOCWait")}
                            />
                        </FormControl>
                        <FormControl >
                            ...
                            <Switch
                                defaultChecked={dataInput?.IsDev}
                                title="Dev"
                                color="error"
                                {...register("IsDev")}
