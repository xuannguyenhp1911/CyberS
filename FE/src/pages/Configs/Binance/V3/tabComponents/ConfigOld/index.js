...
import { getAllStrategies } from '../../../../../../services/Configs/Binance/V3/configOldService';
import { addMessageToast } from '../../../../../../store/slices/Toast';
import ConfigMoreBot from './components/ConfigMoreBot';
import { getAllCoinDelist } from '../../../../../../services/Coins/Binance/coinFuturesService';

function ConfigBinanceOldV3() {
                                    ...
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>
                                            <RemoveRedEyeIcon
                                                ...
                                                onClick={() => {
                                                    navigate("/Configs/Binance/V3/ConfigHistory", {
                                                        state: {
                                                            data: data.data,
...
export default ConfigBinanceOldV3;