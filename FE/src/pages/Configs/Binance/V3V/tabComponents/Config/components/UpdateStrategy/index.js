...
import { updateConfigByIDV3 } from '../../../../../../../../services/Configs/Binance/V3/configService';
...
function UpdateStrategy({
    ...
    const [openOCBonus, setOpenOCBonus] = useState(dataInput?.IsBeta);
                ...
                <div className={styles.formMainData} style={{ marginTop: "10px" }}>
                    ...
                    <div className={clsx(styles.formControl, styles.formMainDataItem, styles.formMainDataSmall)} >
                        ...
                        <FormControl className={clsx(styles.formMainDataSmallItem)}>
                            ...
                            <TextField
                                label="Position"
                                defaultValue={dataInput?.PositionSide}
                                variant="outlined"
                                size="medium"
                        ...
                        <FormControl className={clsx(styles.formMainDataSmallItem)}>
                            <TextField
                                ...
                                label="OC"
                                variant="outlined"
                                defaultValue={dataInput?.OrderChange || 1}
                                size="medium"
                                InputProps={{
                    ...
                    <div className={clsx(styles.formControl, styles.formMainDataItem, styles.formMainDataSmall)} >
                        ...
                        <FormControl className={clsx(styles.formMainDataSmallItem)}>
                            <TextField
                                ...
                                label="OC +"
                                variant="outlined"
                                defaultValue={dataInput?.OCBonus }
                                size="medium"
                                {...register("OCBonus",)}
                                InputProps={{
                                    endAdornment: <InputAdornment position="end">
                        ...
                        <FormControl className={clsx(styles.formMainDataSmallItem)}>
                            <TextField
                                ...
                                label="Expire"
                                variant="outlined"
                                defaultValue={dataInput?.TimeOCBonusExpire }
                                size="medium"
