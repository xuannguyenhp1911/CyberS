...
import { createConfigByBitV3VIP, getAllConfigByBitV3VIP, clearVConfigByBitV3VIP } from "../../../../services/Configs/Binance/V3/configVIPService";
import { addMessageToast } from "../../../../store/slices/Toast";

function StrategiesV3TabVIPBinance() {
    ...
    const tabList = [
        {
            label: "Config",
            value: "Configs/Binance/V3V/Config",
        },
        {
            label: "BigBabol",
            value: "Configs/Binance/V3V/BigBabol",
        },
        {
            label: "Fomo",
            value: "Configs/Binance/V3V/Fomo",
        }
    ]
    ...
    useEffect(() => {
        userData?.userName &&         userData?.userName && userData?.userName != "SuperAdmin"  && navigate("/404")
...
export default StrategiesV3TabVIPBinance;