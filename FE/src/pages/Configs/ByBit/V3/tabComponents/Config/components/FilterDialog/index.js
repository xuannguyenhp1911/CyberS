                ...
                return filterDataRowList.every(filterRow => {
                    ...
                    if (filterRowValue == "Bot") {
                        ...
                        switch (filterRow.data.compare) {
                            case "=":
                                listOK = coinListWith24H.filter(item => item.price24hPcnt * 100 == valueCheck)
                                break
            ...
            contentTitleMore={
                <div style={{
                    ...
                    <Button
                        ...
                        size='small'
                        onDoubleClick={() => {
                            localStorage.setItem("ByBit_V3_Config_Filter", JSON.stringify(filterDataRowList))
                            dispatch(addMessageToast({
                                status: 200,
                    ...
                    {localStorage.getItem("ByBit_V3_Config_Filter") && <Button
                        color='warning'
                        variant='contained'
                        size='small'
                        style={{
                        ...
                        onClick={() => {
                            const ByBit_V3_Config_Filter_Data = localStorage.getItem("ByBit_V3_Config_Filter")
                            const list = JSON.parse(ByBit_V3_Config_Filter_Data) || []
