...
import { Autocomplete, Button, Checkbox, CircularProgress, FormControl, FormControlLabel, FormLabel, InputAdornment, MenuItem, Radio, RadioGroup, Select, Switch, TextField, Tooltip } from "@mui/material";
import { useEffect, useRef, useState } from "react";
import clsx from "clsx";
import { useDispatch } from "react-redux";
import DialogCustom from "../../../../../../../../components/DialogCustom";
import { createStrategies } from "../../../../../../../../services/Configs/ByBIt/V3/waveService";
...
function CreateStrategy({
    ...
    const DEFAULT_REMEMBER_VALUE = JSON.parse(localStorage.getItem("ByBit_V3_Wave"))
    ...
    const handleSubmitCreate = async data => {
        ...
        if (symbolGroupData.length > 0 && botList.length > 0) {
            try {
                ...
                if (data.Remember) {
                    localStorage.setItem("ByBit_V3_Wave", JSON.stringify(data))
                }
            }
            catch (err) {
                dispatch(addMessageToast({
        ...
        >
            ...
            <form className={styles.dialogForm}>
                ...
                <FormControl className={styles.formControl}>
                    ...
                    {isSubmitted && !symbolGroupData.length && <p className="formControlErrorLabel"> Required.</p>}
                    ...
                    <div className={clsx(styles.formControl, styles.formMainDataItem, styles.formMainDataSmall)} >
                        ...
                        <FormControl className={clsx(styles.formMainDataSmallItem)}>
                            <TextField
                                ...
                                label="TP"
                                variant="outlined"
                                defaultValue={DEFAULT_REMEMBER_VALUE?.TakeProfit || 35}
                                size="medium"
                        ...
                        <FormControl className={clsx(styles.formMainDataSmallItem)}>
                            <TextField
                                ...
                                label="Re-TP"
                                variant="outlined"
                                defaultValue={DEFAULT_REMEMBER_VALUE?.ReduceTakeProfit || 15}
                                size="medium"
