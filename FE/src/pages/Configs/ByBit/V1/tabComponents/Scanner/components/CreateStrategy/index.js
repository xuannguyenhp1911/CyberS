...
function CreateStrategy({
    ...
    const DEFAULT_REMEMBER_VALUE = JSON.parse(localStorage.getItem("ByBit_V1_Scan"))
    ...
    const handleGetSpotDataList = async (hasMargin = false) => {
        try {
            ...
            const newData = spotMarginDataListRef.current.filter(item => hasMargin ? true : item.market == "Spot")
        ...
        if (!loadingSyncCoin) {
            try {
                ...
                switch (Market) {
                    ...
                    case "Margin":
                        {
                            res = await syncAllCoinSpotByBit()
                            break
                        }
    ...
    const handleSubmitCreate = async data => {
        ...
        if (onlyPairsSelected.length > 0 && botList.length > 0 && PositionSideSelected) {
            ...
            try {
                ...
                if (data.Remember) {
                    localStorage.setItem("ByBit_V1_Scan", JSON.stringify(data))
                }
            }
            catch (err) {
                dispatch(addMessageToast({
    ...
    const hanleGetAllInit = async () => {
        const resSpot = getAllCoinSpotByBit()
        const resFutures = getAllCoin()
                    ...
                    <div className={clsx(styles.formControl, styles.formMainDataItem, styles.formMainDataSmall)} >
                        ...
                        <FormControl className={clsx(styles.formMainDataSmallItem)}>
                            ...
                            <TextField
                                ...
                                label="Elastic"
                                variant="outlined"
                                defaultValue={DEFAULT_REMEMBER_VALUE?.Elastic || 80}
                                size="medium"
                                InputProps={{
                                    endAdornment: <InputAdornment position="end">
                                        %
                    ...
                    <div className={clsx(styles.formControl, styles.formMainDataItem, styles.formMainDataSmall)} >
                        ...
                        <FormControl className={clsx(styles.formMainDataSmallItem)}>
                            ...
                            <TextField
                                ...
                                label="Exp"
                                variant="outlined"
                                defaultValue={DEFAULT_REMEMBER_VALUE?.AmountExpire || 10}
                                size="medium"
                                InputProps={{
                                    endAdornment: <InputAdornment position="end">
                                        m
                    ...
                    <div className={clsx(styles.formControl, styles.formMainDataItem, styles.formMainDataSmall)} >
                        ...
                        <FormControl className={clsx(styles.formMainDataSmallItem)}>
                            ...
                            <TextField
                                ...
                                label="Expire"
                                variant="outlined"
                                defaultValue={DEFAULT_REMEMBER_VALUE?.Expire || 20}
                                size="medium"
                                InputProps={{
                                    endAdornment: <InputAdornment position="end">
                                        m
                    ...
                    <div className={clsx(styles.formControl, styles.formMainDataItem, styles.formMainDataSmall)} >
                        ...
                        <FormControl className={clsx(styles.formMainDataSmallItem)}>
                            ...
                            <TextField
                                ...
                                label="Turnover"
                                variant="outlined"
                                defaultValue={DEFAULT_REMEMBER_VALUE?.Turnover || 4000}
                                size="medium"
                                InputProps={{
                                    endAdornment: <InputAdornment position="end">
                                        $
