...
import { getAllSymbolSpot, copyMultipleStrategiesToSymbolSpot, copyMultipleStrategiesToBotSpot } from '../../../../../../../../services/Configs/ByBIt/V1/spotService';
import { copyMultipleStrategiesToBotScanner, deleteStrategiesMultipleScanner, updateStrategiesMultipleScanner } from '../../../../../../../../services/Configs/ByBIt/V1/scannerService';
import { NumericFormat } from 'react-number-format';
import { getAllCoinSpotByBit } from '../../../../../../../../services/Coins/ByBit/coinService';
...
function EditMulTreeItem({
    ...
    const handleGetAllBot = async () => {
        try {
            const res = await getAllBotActive("ByBit_V1")
            ...
            const newData = handleDataCheckTreeSelected.map((dataCheckTreeItem) => (
                {
                    ...
                    UpdatedFields: filterDataRowList.map(filterRow => {
                        ...
                        if (typeof (valueHandle) === "number" && !["Expire", "Turnover", "Elastic", "Blacklist", "OnlyPairs"].includes(filedValue)) {
    ...
    const handleGetListSymbolMarket = async () => {
        ...
        switch (market) {
            case "Spot": {
                const response = await getAllCoinSpotByBit()
