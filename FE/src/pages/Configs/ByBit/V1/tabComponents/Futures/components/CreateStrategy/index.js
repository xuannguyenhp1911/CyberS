...
import { createStrategiesSpot } from "../../../../../../../../services/Configs/ByBIt/V1/futuresService";
...
function CreateStrategy({
    ...
    const DEFAULT_REMEMBER_VALUE = JSON.parse(localStorage.getItem("ByBit_V1_Futures"))
    ...
    const handleSubmitCreate = async data => {
        ...
        if (symbolGroupData.length > 0 && botList.length > 0) {
            try {
                ...
                if (data.Remember) {
                    localStorage.setItem("ByBit_V1_Futures", JSON.stringify(data))
                }
            }
            catch (err) {
                dispatch(addMessageToast({
