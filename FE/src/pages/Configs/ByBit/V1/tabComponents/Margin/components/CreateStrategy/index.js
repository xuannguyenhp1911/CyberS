...
import { createStrategiesSpot, getMarginBorrowCheck } from "../../../../../../../../services/Configs/ByBIt/V1/marginService";
...
function CreateStrategy({
    ...
    const DEFAULT_REMEMBER_VALUE = JSON.parse(localStorage.getItem("ByBit_V1_Margin"))
    ...
    const handleSubmitCreate = async data => {
        ...
        if (symbolGroupData.length > 0 && botList.length > 0) {
            try {
                ...
                if (data.Remember) {
                    localStorage.setItem("ByBit_V1_Margin", JSON.stringify(data))
                }
            }
            catch (err) {
                dispatch(addMessageToast({
            ...
            <form className={styles.dialogForm}>
                ...
                <div className={styles.formMainData}>
                    ...
                    >
                        ...
                        {isSubmitted && !positionSideValue && <p className="formControlErrorLabel">The Position Required.</p>}
                    </FormControl>
                    ...
                    <div className={clsx(styles.formControl, styles.formMainDataItem, styles.formMainDataSmall)} >
                        ...
                        <FormControl className={clsx(styles.formMainDataSmallItem)}>
                            <TextField
                                ...
                                label="Exp"
                                variant="outlined"
                                defaultValue={DEFAULT_REMEMBER_VALUE?.AmountExpire || 3}
                                size="medium"
                                InputProps={{
                                    endAdornment: <InputAdornment position="end">
                                        m
                    ...
                    <FormControl className={clsx(styles.formControl, styles.formMainDataItem)}>
                        <TextField
                            ...
                            label="Expire"
                            variant="outlined"
                            defaultValue={DEFAULT_REMEMBER_VALUE?.Expire || 15}
                            size="medium"
                            InputProps={{
                                endAdornment: <InputAdornment position="end">
                                    m
                    ...
                    <FormControl className={clsx(styles.formControl, styles.formMainDataItem)}>
                        <TextField
                            ...
                            variant="outlined"
                            defaultValue={DEFAULT_REMEMBER_VALUE?.AmountIncreaseOC || 10}
                            size="medium"
                            InputProps={{
                                endAdornment: <InputAdornment position="end">
                                    %
