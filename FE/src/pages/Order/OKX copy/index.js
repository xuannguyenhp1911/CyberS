...
import { getAllOrderOKXV1, cancelOrderAllOKXV1 } from "../../../services/Orders/OKX/orderService";
...
function OrderOKXV1() {
    ...
    const tableColumns = [
        ...
        },
        {
            ...
            type: "actions",
            renderCell: (params) => {
                const value = params.value == "buy" ? "Buy" : "Sell"
                return <p style={{
    ...
    const handleGetAllOrder = async (botListInput = botList, alert = true) => {
        ...
        try {
            const res = await getAllOrderOKXV1(botListInput.slice(1))
                ...
                confirmCloseAllPosition.isOpen && (
                    <DialogCustom
                        ...
                        onSubmit={async () => {
                            ...
                            try {
                                const res = await cancelOrderAllOKXV1(positionData)
