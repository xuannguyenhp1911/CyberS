...
import { getAllOrderByBit, cancelOrderAllByBit } from "../../../services/Orders/ByBit/orderService";

function OrdersByBit() {
    ...
    const tableColumns = [
        ...
        },
        {
            ...
            renderCell: (params) => {
                ...
                return <p>{params.value.split("USDT")[0]} {instTypeIcon}</p>
            }
        },
        {
            field: 'botName',
    ...
    const handleGetAllBotByUserID = async () => {
        try {
            const res = await getAllBotOnlyApiKeyByUserID(userData._id, "ByBit_V3")
    ...
    const handleGetAllBotAndPosition = async () => {
        ...
        const res = await getAllBotOnlyApiKey("ByBit_V3")
        const dataAll = res.data.data
    ...
    const handleGetAllOrder = async (botListInput = botList, alert = true) => {
        ...
        try {
            const res = await getAllOrderByBit(botListInput.slice(1))
                ...
                confirmCloseAllPosition.isOpen && (
                    <DialogCustom
                        ...
                        onSubmit={async () => {
                            ...
                            try {
                                const res = await cancelOrderAllByBit(positionData)
