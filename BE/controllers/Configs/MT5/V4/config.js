...
const MT5_BASE_URL = 'https://mt5.mtapi.io'
const dataCoinByBitController = {
    ...
    testMT5: async (req, res) => {
        const dataSend = req.body;

        try {

            //             const mt5Response = await axios.get(`${MT5_BASE_URL}/OnQuote`, {
            //                 params: {
            //                     id: "5f8a4a45-0f9a-4756-8dd8-b466853d0717",
            //                 }
            //             });
            //             // const mt5Response = await axios.get(`${MT5_BASE_URL}/OrderClose`, {
            //             //     params: {
            //             //         id: "5f8a4a45-0f9a-4756-8dd8-b466853d0717",
            //             //         ticket:3237878114
            //             //     }
            ...
            const ws = new WebSocket(MT5_BASE_URL);
            ...
            // const resData = mt5Response.data
            // res.customResponse(resData.code == "DONE" ? 200 : 400, "Successful", resData);
        } catch (error) {
