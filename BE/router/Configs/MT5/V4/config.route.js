...
const dataCoinByBitController = require('../../../../controllers/Configs/MT5/V4/config');

router.post('/testMT5', MiddlewareController.verifyToken, dataCoinByBitController.testMT5);
